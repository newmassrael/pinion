...
// From: widgets/key_sequence.scxml
//
...
// SCE-MAP: key_sequence.scxml:60 :: _machine
...
impl KeySequenceEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [KeySequenceEvent] = &[
        KeySequenceEvent::Blur,
        KeySequenceEvent::Cancel,
        KeySequenceEvent::Commit,
        KeySequenceEvent::Disable,
        KeySequenceEvent::Enable,
        KeySequenceEvent::Record,
    ];
}
...
impl KeySequencePolicy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: KeySequenceState::Idle,
...
impl Default for KeySequencePolicy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for KeySequencePolicy {
    type State = KeySequenceState;
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            KeySequenceState::Disabled => 2,
            KeySequenceState::Idle => 0,
            KeySequenceState::Recording => 1,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            KeySequenceEvent::Blur => "blur",
            KeySequenceEvent::Cancel => "cancel",
            KeySequenceEvent::Commit => "commit",
            KeySequenceEvent::Disable => "disable",
            KeySequenceEvent::Enable => "enable",
            KeySequenceEvent::KeysequenceCaptured => "keysequence.captured",
            KeySequenceEvent::Record => "record",
            KeySequenceEvent::Null => "",
        }
    }

    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "blur" => Some(KeySequenceEvent::Blur),
            "cancel" => Some(KeySequenceEvent::Cancel),
            "commit" => Some(KeySequenceEvent::Commit),
            "disable" => Some(KeySequenceEvent::Disable),
            "enable" => Some(KeySequenceEvent::Enable),
            "keysequence.captured" => Some(KeySequenceEvent::KeysequenceCaptured),
            "record" => Some(KeySequenceEvent::Record),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            KeySequenceState::Disabled => "disabled",
            KeySequenceState::Idle => "idle",
            KeySequenceState::Recording => "recording",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "disabled" => Some(KeySequenceState::Disabled),
            "idle" => Some(KeySequenceState::Idle),
            "recording" => Some(KeySequenceState::Recording),
            _ => None,
        }
    }
    ...
    #[doc = "SCE-MAP: key_sequence.scxml:60 :: _machine"]
// SCE-MAP: key_sequence.scxml:60 :: _machine
        ...
        match self.last_transition_source_state {
            KeySequenceState::Recording => {
                match self.last_transition_index {
                    0 => {
                        // SCE-MAP: key_sequence.scxml:71 :: recording :: _transition_0
                        // W3C SCXML 3.13: Transition 0 actions

// W3C SCXML 3.8.1: <raise event="keysequence.captured">
engine.raise(sce_rust_runtime::EventWithMetadata::new(KeySequenceEvent::KeysequenceCaptured));
                    }
                    2 => {
                        // SCE-MAP: key_sequence.scxml:75 :: recording :: _transition_2
...
impl KeySequencePolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: KeySequenceState,
        event: KeySequenceEvent,
        current_state: &mut KeySequenceState,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            KeySequenceState::Disabled => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == KeySequenceEvent::Enable {
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = KeySequenceState::Idle;
            ...
            KeySequenceState::Idle => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == KeySequenceEvent::Record {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                        self.has_transition_actions = false;
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = KeySequenceState::Recording;
                            *transition_taken = true;
                        return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == KeySequenceEvent::Disable {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = KeySequenceState::Disabled;
                            *transition_taken = true;
                        return true;
                }
                false
            ...
            KeySequenceState::Recording => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == KeySequenceEvent::Commit {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == KeySequenceEvent::Cancel {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 1;
                        self.has_transition_actions = false;
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == KeySequenceEvent::Blur {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
