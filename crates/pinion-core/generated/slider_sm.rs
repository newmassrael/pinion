...
// SCE-MAP: slider.scxml:32 :: _machine
...
impl SliderEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [SliderEvent] = &[
        SliderEvent::Disable,
        SliderEvent::Enable,
        SliderEvent::PointerCancel,
        SliderEvent::PointerDown,
        SliderEvent::PointerEnter,
        SliderEvent::PointerLeave,
        SliderEvent::PointerUp,
    ];
}
...
impl SliderPolicy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: SliderState::Idle,
...
impl StatePolicy for SliderPolicy {
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            SliderState::Disabled => 3,
            SliderState::Dragging => 2,
            SliderState::Hover => 1,
            SliderState::Idle => 0,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            ...
            SliderEvent::PointerCancel => "pointer_cancel",
            SliderEvent::PointerDown => "pointer_down",
            SliderEvent::PointerEnter => "pointer_enter",
            SliderEvent::PointerLeave => "pointer_leave",
            SliderEvent::PointerUp => "pointer_up",
            SliderEvent::SliderActivate => "slider.activate",
            SliderEvent::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            ...
            "pointer_cancel" => Some(SliderEvent::PointerCancel),
            "pointer_down" => Some(SliderEvent::PointerDown),
            "pointer_enter" => Some(SliderEvent::PointerEnter),
            "pointer_leave" => Some(SliderEvent::PointerLeave),
            "pointer_up" => Some(SliderEvent::PointerUp),
            "slider.activate" => Some(SliderEvent::SliderActivate),
            _ => None,
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "disabled" => Some(SliderState::Disabled),
            "dragging" => Some(SliderState::Dragging),
            "hover" => Some(SliderState::Hover),
            "idle" => Some(SliderState::Idle),
            _ => None,
        }
    }
    ...
    #[doc = "SCE-MAP: slider.scxml:32 :: _machine"]
// SCE-MAP: slider.scxml:32 :: _machine
        ...
        match self.last_transition_source_state {
            SliderState::Dragging => {
                match self.last_transition_index {
                    0 => {
                        // SCE-MAP: slider.scxml:58 :: dragging :: _transition_0
                        // W3C SCXML 3.13: Transition 0 actions

// W3C SCXML 3.8.1: <raise event="slider.activate">
engine.raise(sce_rust_runtime::EventWithMetadata::new(SliderEvent::SliderActivate));
                    }
                    _ => {}
                }
            }
...
impl SliderPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: SliderState,
        event: SliderEvent,
        current_state: &mut SliderState,
        ...
        match check_state {
            SliderState::Disabled => {
                ...
                if event == SliderEvent::Enable {
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = SliderState::Idle;
            ...
            SliderState::Dragging => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == SliderEvent::PointerUp {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = SliderState::Hover;
                            *transition_taken = true;
                        return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == SliderEvent::PointerLeave {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == SliderEvent::PointerCancel {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
            ...
            SliderState::Hover => {
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == SliderEvent::PointerDown {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 2;
                        self.has_transition_actions = false;
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = SliderState::Dragging;
                            *transition_taken = true;
                        return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
            ...
            SliderState::Idle => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == SliderEvent::PointerEnter {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                        self.has_transition_actions = false;
