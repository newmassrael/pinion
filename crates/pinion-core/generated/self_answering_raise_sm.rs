...
// From: fixtures/self_answering_raise.scxml
//
...
// SCE-MAP: self_answering_raise.scxml:32 :: _machine
...
pub enum SelfAnsweringRaiseState {
...
pub enum SelfAnsweringRaiseEvent {
    Loop,
    Settle,
    Start,
...
impl SelfAnsweringRaiseEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [SelfAnsweringRaiseEvent] = &[
        SelfAnsweringRaiseEvent::Settle,
        SelfAnsweringRaiseEvent::Start,
    ];
}
...
impl SelfAnsweringRaisePolicy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: SelfAnsweringRaiseState::Idle,
...
impl Default for SelfAnsweringRaisePolicy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for SelfAnsweringRaisePolicy {
    type State = SelfAnsweringRaiseState;
    type Event = SelfAnsweringRaiseEvent;
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            SelfAnsweringRaiseState::Idle => 0,
            SelfAnsweringRaiseState::Spin => 1,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            SelfAnsweringRaiseEvent::Loop => "loop",
            SelfAnsweringRaiseEvent::Settle => "settle",
            SelfAnsweringRaiseEvent::Start => "start",
            SelfAnsweringRaiseEvent::Null => "",
        }
    }

    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "loop" => Some(SelfAnsweringRaiseEvent::Loop),
            "settle" => Some(SelfAnsweringRaiseEvent::Settle),
            "start" => Some(SelfAnsweringRaiseEvent::Start),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            SelfAnsweringRaiseState::Idle => "idle",
            SelfAnsweringRaiseState::Spin => "spin",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "idle" => Some(SelfAnsweringRaiseState::Idle),
            "spin" => Some(SelfAnsweringRaiseState::Spin),
            _ => None,
        }
    }
    ...
    #[doc = "SCE-MAP: self_answering_raise.scxml:32 :: _machine"]
// SCE-MAP: self_answering_raise.scxml:32 :: _machine
    fn execute_entry_actions(&mut self, state: Self::State, engine: &mut sce_rust_runtime::Engine<Self>, path_child: Option<Self::State>) {
        ...
        match state {
            SelfAnsweringRaiseState::Spin => {
                // SCE-MAP: self_answering_raise.scxml:41 :: spin :: _state_body
                // W3C SCXML 3.8: onentry block 1/1
                // Labeled block allows actions to break out on error (W3C 3.8: error stops block)
                'action_block: {

// W3C SCXML 3.8.1: <raise event="loop">
engine.raise(sce_rust_runtime::EventWithMetadata::new(SelfAnsweringRaiseEvent::Loop));
                }
            }
            _ => {}
        }
        ...
        match self.last_transition_source_state {
            SelfAnsweringRaiseState::Spin => {
                match self.last_transition_index {
                    0 => {
                        // SCE-MAP: self_answering_raise.scxml:50 :: spin :: _transition_0
...
impl SelfAnsweringRaisePolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: SelfAnsweringRaiseState,
        event: SelfAnsweringRaiseEvent,
        current_state: &mut SelfAnsweringRaiseState,
        ...
        match check_state {
            SelfAnsweringRaiseState::Idle => {
                ...
                if event == SelfAnsweringRaiseEvent::Start {
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = SelfAnsweringRaiseState::Spin;
            ...
            SelfAnsweringRaiseState::Spin => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == SelfAnsweringRaiseEvent::Loop {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == SelfAnsweringRaiseEvent::Settle {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = SelfAnsweringRaiseState::Idle;
                            *transition_taken = true;
                        return true;
                }
                false
