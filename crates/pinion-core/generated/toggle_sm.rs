...
// SCE-MAP: toggle.scxml:18 :: _machine
...
impl ToggleEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [ToggleEvent] = &[
        ToggleEvent::Disable,
        ToggleEvent::Enable,
        ToggleEvent::KeyboardActivate,
        ToggleEvent::PointerCancel,
        ToggleEvent::PointerDown,
        ToggleEvent::PointerEnter,
        ToggleEvent::PointerLeave,
        ToggleEvent::PointerUp,
    ];
}
...
pub struct TogglePolicy {
    ...
    last_transition_source_state: ToggleState,
...
impl TogglePolicy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: ToggleState::Idle,
...
impl StatePolicy for TogglePolicy {
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            ToggleState::Disabled => 3,
            ToggleState::Hover => 1,
            ToggleState::Idle => 0,
            ToggleState::Pressed => 2,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            ...
            ToggleEvent::KeyboardActivate => "keyboard_activate",
            ToggleEvent::PointerCancel => "pointer_cancel",
            ToggleEvent::PointerDown => "pointer_down",
            ToggleEvent::PointerEnter => "pointer_enter",
            ToggleEvent::PointerLeave => "pointer_leave",
            ToggleEvent::PointerUp => "pointer_up",
            ToggleEvent::ToggleActivate => "toggle.activate",
            ToggleEvent::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            ...
            "keyboard_activate" => Some(ToggleEvent::KeyboardActivate),
            "pointer_cancel" => Some(ToggleEvent::PointerCancel),
            "pointer_down" => Some(ToggleEvent::PointerDown),
            "pointer_enter" => Some(ToggleEvent::PointerEnter),
            "pointer_leave" => Some(ToggleEvent::PointerLeave),
            "pointer_up" => Some(ToggleEvent::PointerUp),
            "toggle.activate" => Some(ToggleEvent::ToggleActivate),
            _ => None,
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "disabled" => Some(ToggleState::Disabled),
            "hover" => Some(ToggleState::Hover),
            "idle" => Some(ToggleState::Idle),
            "pressed" => Some(ToggleState::Pressed),
            _ => None,
        }
    }
    ...
    #[doc = "SCE-MAP: toggle.scxml:18 :: _machine"]
// SCE-MAP: toggle.scxml:18 :: _machine
        ...
        match self.last_transition_source_state {
            ToggleState::Hover => {
                match self.last_transition_index {
                    3 => {
                        // SCE-MAP: toggle.scxml:70 :: hover :: _transition_3
                        // W3C SCXML 3.13: Transition 3 actions

// W3C SCXML 3.8.1: <raise event="toggle.activate">
engine.raise(sce_rust_runtime::EventWithMetadata::new(ToggleEvent::ToggleActivate));
                    }
                    _ => {}
                }
            }
            ToggleState::Idle => {
                match self.last_transition_index {
                    1 => {
                        // SCE-MAP: toggle.scxml:60 :: idle :: _transition_1
...
engine.raise(sce_rust_runtime::EventWithMetadata::new(ToggleEvent::ToggleActivate));
            ...
            ToggleState::Pressed => {
                match self.last_transition_index {
                    0 => {
                        // SCE-MAP: toggle.scxml:77 :: pressed :: _transition_0
...
impl TogglePolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: ToggleState,
        event: ToggleEvent,
        current_state: &mut ToggleState,
        ...
        match check_state {
            ToggleState::Disabled => {
                ...
                if event == ToggleEvent::Enable {
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = ToggleState::Idle;
            ...
            ToggleState::Hover => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == ToggleEvent::PointerLeave {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                        self.has_transition_actions = false;
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == ToggleEvent::PointerCancel {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == ToggleEvent::PointerDown {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = ToggleState::Pressed;
                            *transition_taken = true;
                        return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == ToggleEvent::KeyboardActivate {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                ...
                if event == ToggleEvent::Disable {
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = ToggleState::Disabled;
                            *transition_taken = true;
                        return true;
                }
                false
            ...
            ToggleState::Idle => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == ToggleEvent::PointerEnter {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                        self.has_transition_actions = false;
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = ToggleState::Hover;
                            *transition_taken = true;
                        return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
            ...
            ToggleState::Pressed => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == ToggleEvent::PointerUp {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                        self.has_transition_actions = true;
