...
// SCE-MAP: checkbox.scxml:20 :: _machine
...
impl CheckboxEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [CheckboxEvent] = &[
        CheckboxEvent::Disable,
        CheckboxEvent::Enable,
        CheckboxEvent::KeyboardActivate,
        CheckboxEvent::PointerCancel,
        CheckboxEvent::PointerDown,
        CheckboxEvent::PointerEnter,
        CheckboxEvent::PointerLeave,
        CheckboxEvent::PointerUp,
    ];
}
...
pub struct CheckboxPolicy {
    ...
    last_transition_source_state: CheckboxState,
...
impl CheckboxPolicy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: CheckboxState::Idle,
...
impl StatePolicy for CheckboxPolicy {
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            CheckboxState::Disabled => 3,
            CheckboxState::Hover => 1,
            CheckboxState::Idle => 0,
            CheckboxState::Pressed => 2,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            CheckboxEvent::CheckboxActivate => "checkbox.activate",
            CheckboxEvent::Disable => "disable",
            CheckboxEvent::Enable => "enable",
            CheckboxEvent::KeyboardActivate => "keyboard_activate",
            CheckboxEvent::PointerCancel => "pointer_cancel",
            CheckboxEvent::PointerDown => "pointer_down",
            CheckboxEvent::PointerEnter => "pointer_enter",
            CheckboxEvent::PointerLeave => "pointer_leave",
            CheckboxEvent::PointerUp => "pointer_up",
            CheckboxEvent::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "checkbox.activate" => Some(CheckboxEvent::CheckboxActivate),
            "disable" => Some(CheckboxEvent::Disable),
            "enable" => Some(CheckboxEvent::Enable),
            "keyboard_activate" => Some(CheckboxEvent::KeyboardActivate),
            "pointer_cancel" => Some(CheckboxEvent::PointerCancel),
            "pointer_down" => Some(CheckboxEvent::PointerDown),
            "pointer_enter" => Some(CheckboxEvent::PointerEnter),
            "pointer_leave" => Some(CheckboxEvent::PointerLeave),
            "pointer_up" => Some(CheckboxEvent::PointerUp),
            _ => None,
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "disabled" => Some(CheckboxState::Disabled),
            "hover" => Some(CheckboxState::Hover),
            "idle" => Some(CheckboxState::Idle),
            "pressed" => Some(CheckboxState::Pressed),
            _ => None,
        }
    }
    ...
    #[doc = "SCE-MAP: checkbox.scxml:20 :: _machine"]
// SCE-MAP: checkbox.scxml:20 :: _machine
        ...
        match self.last_transition_source_state {
            CheckboxState::Hover => {
                match self.last_transition_index {
                    3 => {
                        // SCE-MAP: checkbox.scxml:72 :: hover :: _transition_3
                        // W3C SCXML 3.13: Transition 3 actions

// W3C SCXML 3.8.1: <raise event="checkbox.activate">
engine.raise(sce_rust_runtime::EventWithMetadata::new(CheckboxEvent::CheckboxActivate));
                    }
                    _ => {}
                }
            }
            CheckboxState::Idle => {
                match self.last_transition_index {
                    1 => {
                        // SCE-MAP: checkbox.scxml:62 :: idle :: _transition_1
...
engine.raise(sce_rust_runtime::EventWithMetadata::new(CheckboxEvent::CheckboxActivate));
            ...
            CheckboxState::Pressed => {
                match self.last_transition_index {
                    0 => {
                        // SCE-MAP: checkbox.scxml:79 :: pressed :: _transition_0
...
impl CheckboxPolicy {
    ...
    fn try_transition_in_state(
        ...
        event: CheckboxEvent,
        current_state: &mut CheckboxState,
        ...
        match check_state {
            CheckboxState::Disabled => {
                ...
                if event == CheckboxEvent::Enable {
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = CheckboxState::Idle;
            ...
            CheckboxState::Hover => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == CheckboxEvent::PointerLeave {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                        self.has_transition_actions = false;
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == CheckboxEvent::PointerCancel {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == CheckboxEvent::PointerDown {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = CheckboxState::Pressed;
                            *transition_taken = true;
                        return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == CheckboxEvent::KeyboardActivate {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == CheckboxEvent::Disable {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = CheckboxState::Disabled;
                            *transition_taken = true;
                        return true;
                }
                false
            ...
            CheckboxState::Idle => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == CheckboxEvent::PointerEnter {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                        self.has_transition_actions = false;
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = CheckboxState::Hover;
                            *transition_taken = true;
                        return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
            ...
            CheckboxState::Pressed => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == CheckboxEvent::PointerUp {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                        self.has_transition_actions = true;
