...
impl AppEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [AppEvent] = &[
    ];
}
...
pub struct AppPolicy {
    ...
    last_transition_source_state: AppState,
...
impl AppPolicy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: AppState::Main,
            session_id: None,
...
impl StatePolicy for AppPolicy {
    type State = AppState;
    type Event = AppEvent;
    ...
    #[doc = "SCE-MAP: app.scxml:16 :: _machine"]
// SCE-MAP: app.scxml:16 :: _machine
