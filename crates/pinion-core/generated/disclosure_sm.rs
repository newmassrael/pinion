...
// SCE-MAP: disclosure.scxml:23 :: _machine
...
impl DisclosureEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [DisclosureEvent] = &[
        DisclosureEvent::Disable,
        DisclosureEvent::Enable,
        DisclosureEvent::KeyboardActivate,
        DisclosureEvent::PointerCancel,
        DisclosureEvent::PointerDown,
        DisclosureEvent::PointerEnter,
        DisclosureEvent::PointerLeave,
        DisclosureEvent::PointerUp,
    ];
}
...
pub struct DisclosurePolicy {
    ...
    last_transition_source_state: DisclosureState,
...
impl DisclosurePolicy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: DisclosureState::Idle,
...
impl StatePolicy for DisclosurePolicy {
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            DisclosureState::Disabled => 3,
            DisclosureState::Hover => 1,
            DisclosureState::Idle => 0,
            DisclosureState::Pressed => 2,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            ...
            DisclosureEvent::DisclosureActivate => "disclosure.activate",
            DisclosureEvent::Enable => "enable",
            DisclosureEvent::KeyboardActivate => "keyboard_activate",
            DisclosureEvent::PointerCancel => "pointer_cancel",
            DisclosureEvent::PointerDown => "pointer_down",
            DisclosureEvent::PointerEnter => "pointer_enter",
            DisclosureEvent::PointerLeave => "pointer_leave",
            DisclosureEvent::PointerUp => "pointer_up",
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            ...
            "disclosure.activate" => Some(DisclosureEvent::DisclosureActivate),
            "enable" => Some(DisclosureEvent::Enable),
            "keyboard_activate" => Some(DisclosureEvent::KeyboardActivate),
            "pointer_cancel" => Some(DisclosureEvent::PointerCancel),
            "pointer_down" => Some(DisclosureEvent::PointerDown),
            "pointer_enter" => Some(DisclosureEvent::PointerEnter),
            "pointer_leave" => Some(DisclosureEvent::PointerLeave),
            "pointer_up" => Some(DisclosureEvent::PointerUp),
            _ => None,
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "disabled" => Some(DisclosureState::Disabled),
            "hover" => Some(DisclosureState::Hover),
            "idle" => Some(DisclosureState::Idle),
            "pressed" => Some(DisclosureState::Pressed),
            _ => None,
        }
    }
    ...
    #[doc = "SCE-MAP: disclosure.scxml:23 :: _machine"]
// SCE-MAP: disclosure.scxml:23 :: _machine
...
// SCE-MAP: disclosure.scxml:23 :: _machine
    fn execute_transition_actions(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        ...
        match self.last_transition_source_state {
            DisclosureState::Hover => {
                match self.last_transition_index {
                    3 => {
                        // SCE-MAP: disclosure.scxml:75 :: hover :: _transition_3
                        // W3C SCXML 3.13: Transition 3 actions

// W3C SCXML 3.8.1: <raise event="disclosure.activate">
engine.raise(sce_rust_runtime::EventWithMetadata::new(DisclosureEvent::DisclosureActivate));
                    }
                    _ => {}
                }
            }
            DisclosureState::Idle => {
                match self.last_transition_index {
                    1 => {
                        // SCE-MAP: disclosure.scxml:65 :: idle :: _transition_1
...
engine.raise(sce_rust_runtime::EventWithMetadata::new(DisclosureEvent::DisclosureActivate));
            ...
            DisclosureState::Pressed => {
                match self.last_transition_index {
                    0 => {
                        // SCE-MAP: disclosure.scxml:82 :: pressed :: _transition_0
...
impl DisclosurePolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: DisclosureState,
        event: DisclosureEvent,
        current_state: &mut DisclosureState,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            DisclosureState::Disabled => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == DisclosureEvent::Enable {
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = DisclosureState::Idle;
            ...
            DisclosureState::Hover => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == DisclosureEvent::PointerLeave {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                        self.has_transition_actions = false;
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == DisclosureEvent::PointerCancel {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == DisclosureEvent::PointerDown {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = DisclosureState::Pressed;
                            *transition_taken = true;
                        return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == DisclosureEvent::KeyboardActivate {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == DisclosureEvent::Disable {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = DisclosureState::Disabled;
                            *transition_taken = true;
                        return true;
                }
                false
            ...
            DisclosureState::Idle => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == DisclosureEvent::PointerEnter {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                        self.has_transition_actions = false;
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = DisclosureState::Hover;
                            *transition_taken = true;
                        return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
            ...
            DisclosureState::Pressed => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == DisclosureEvent::PointerUp {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                        self.has_transition_actions = true;
