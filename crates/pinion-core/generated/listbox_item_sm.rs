...
// From: widgets/listbox_item.scxml
//
...
// SCE-MAP: listbox_item.scxml:31 :: _machine
...
impl ListboxItemEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [ListboxItemEvent] = &[
        ListboxItemEvent::Disable,
        ListboxItemEvent::Enable,
        ListboxItemEvent::KeyboardActivate,
        ListboxItemEvent::PointerCancel,
...
impl ListboxItemPolicy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: ListboxItemState::Idle,
...
impl Default for ListboxItemPolicy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for ListboxItemPolicy {
    type State = ListboxItemState;
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            ListboxItemState::Disabled => 3,
            ListboxItemState::Hover => 1,
            ListboxItemState::Idle => 0,
            ListboxItemState::Pressed => 2,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            ListboxItemEvent::Disable => "disable",
            ListboxItemEvent::Enable => "enable",
            ListboxItemEvent::KeyboardActivate => "keyboard_activate",
            ListboxItemEvent::ListboxItemActivate => "listbox_item.activate",
            ListboxItemEvent::PointerCancel => "pointer_cancel",
            ListboxItemEvent::PointerDown => "pointer_down",
            ListboxItemEvent::PointerEnter => "pointer_enter",
            ListboxItemEvent::PointerLeave => "pointer_leave",
            ListboxItemEvent::PointerUp => "pointer_up",
            ListboxItemEvent::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            ...
            "keyboard_activate" => Some(ListboxItemEvent::KeyboardActivate),
            "listbox_item.activate" => Some(ListboxItemEvent::ListboxItemActivate),
            "pointer_cancel" => Some(ListboxItemEvent::PointerCancel),
            "pointer_down" => Some(ListboxItemEvent::PointerDown),
            "pointer_enter" => Some(ListboxItemEvent::PointerEnter),
            "pointer_leave" => Some(ListboxItemEvent::PointerLeave),
            "pointer_up" => Some(ListboxItemEvent::PointerUp),
            _ => None,
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "disabled" => Some(ListboxItemState::Disabled),
            "hover" => Some(ListboxItemState::Hover),
            "idle" => Some(ListboxItemState::Idle),
            "pressed" => Some(ListboxItemState::Pressed),
            _ => None,
        }
    }
    ...
    #[doc = "SCE-MAP: listbox_item.scxml:31 :: _machine"]
// SCE-MAP: listbox_item.scxml:31 :: _machine
        ...
        match self.last_transition_source_state {
            ListboxItemState::Hover => {
                match self.last_transition_index {
                    3 => {
                        // SCE-MAP: listbox_item.scxml:83 :: hover :: _transition_3
                        // W3C SCXML 3.13: Transition 3 actions

// W3C SCXML 3.8.1: <raise event="listbox_item.activate">
engine.raise(sce_rust_runtime::EventWithMetadata::new(ListboxItemEvent::ListboxItemActivate));
                    }
                    _ => {}
                }
            }
            ListboxItemState::Idle => {
                match self.last_transition_index {
                    1 => {
                        // SCE-MAP: listbox_item.scxml:73 :: idle :: _transition_1
...
engine.raise(sce_rust_runtime::EventWithMetadata::new(ListboxItemEvent::ListboxItemActivate));
            ...
            ListboxItemState::Pressed => {
                match self.last_transition_index {
                    0 => {
                        // SCE-MAP: listbox_item.scxml:90 :: pressed :: _transition_0
...
impl ListboxItemPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: ListboxItemState,
        event: ListboxItemEvent,
        current_state: &mut ListboxItemState,
        ...
        match check_state {
            ListboxItemState::Disabled => {
                ...
                if event == ListboxItemEvent::Enable {
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = ListboxItemState::Idle;
            ...
            ListboxItemState::Hover => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == ListboxItemEvent::PointerLeave {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                        self.has_transition_actions = false;
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == ListboxItemEvent::PointerCancel {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == ListboxItemEvent::PointerDown {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = ListboxItemState::Pressed;
                            *transition_taken = true;
                        return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == ListboxItemEvent::KeyboardActivate {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == ListboxItemEvent::Disable {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = ListboxItemState::Disabled;
                            *transition_taken = true;
                        return true;
                }
                false
            ...
            ListboxItemState::Idle => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == ListboxItemEvent::PointerEnter {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                        self.has_transition_actions = false;
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = ListboxItemState::Hover;
                            *transition_taken = true;
                        return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
            ...
            ListboxItemState::Pressed => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == ListboxItemEvent::PointerUp {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                        self.has_transition_actions = true;
