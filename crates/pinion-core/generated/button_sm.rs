...
// SCE-MAP: button.scxml:17 :: _machine
...
impl ButtonEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [ButtonEvent] = &[
        ButtonEvent::Disable,
        ButtonEvent::Enable,
        ButtonEvent::KeyboardActivate,
        ButtonEvent::PointerCancel,
        ButtonEvent::PointerDown,
        ButtonEvent::PointerEnter,
...
pub struct ButtonPolicy {
    ...
    last_transition_source_state: ButtonState,
...
impl ButtonPolicy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: ButtonState::Idle,
...
impl StatePolicy for ButtonPolicy {
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            ButtonEvent::ButtonActivate => "button.activate",
            ButtonEvent::Disable => "disable",
            ButtonEvent::Enable => "enable",
            ButtonEvent::KeyboardActivate => "keyboard_activate",
            ButtonEvent::PointerCancel => "pointer_cancel",
            ButtonEvent::PointerDown => "pointer_down",
            ButtonEvent::PointerEnter => "pointer_enter",
            ButtonEvent::PointerLeave => "pointer_leave",
            ButtonEvent::PointerUp => "pointer_up",
            ButtonEvent::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "button.activate" => Some(ButtonEvent::ButtonActivate),
            "disable" => Some(ButtonEvent::Disable),
            "enable" => Some(ButtonEvent::Enable),
            "keyboard_activate" => Some(ButtonEvent::KeyboardActivate),
            "pointer_cancel" => Some(ButtonEvent::PointerCancel),
            "pointer_down" => Some(ButtonEvent::PointerDown),
            "pointer_enter" => Some(ButtonEvent::PointerEnter),
            "pointer_leave" => Some(ButtonEvent::PointerLeave),
            "pointer_up" => Some(ButtonEvent::PointerUp),
            _ => None,
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "disabled" => Some(ButtonState::Disabled),
            "hover" => Some(ButtonState::Hover),
            "idle" => Some(ButtonState::Idle),
    ...
    #[doc = "SCE-MAP: button.scxml:17 :: _machine"]
// SCE-MAP: button.scxml:17 :: _machine
        ...
        match self.last_transition_source_state {
            ButtonState::Hover => {
                match self.last_transition_index {
                    3 => {
                        // SCE-MAP: button.scxml:69 :: hover :: _transition_3
                        // W3C SCXML 3.13: Transition 3 actions

// W3C SCXML 3.8.1: <raise event="button.activate">
engine.raise(sce_rust_runtime::EventWithMetadata::new(ButtonEvent::ButtonActivate));
                    }
                    _ => {}
                }
            }
            ButtonState::Idle => {
                match self.last_transition_index {
                    1 => {
                        // SCE-MAP: button.scxml:59 :: idle :: _transition_1
...
engine.raise(sce_rust_runtime::EventWithMetadata::new(ButtonEvent::ButtonActivate));
            ...
            ButtonState::Pressed => {
                match self.last_transition_index {
                    0 => {
                        // SCE-MAP: button.scxml:76 :: pressed :: _transition_0
...
impl ButtonPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: ButtonState,
        event: ButtonEvent,
        current_state: &mut ButtonState,
        ...
        match check_state {
            ...
            ButtonState::Hover => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == ButtonEvent::PointerLeave {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                        self.has_transition_actions = false;
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == ButtonEvent::PointerCancel {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == ButtonEvent::PointerDown {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == ButtonEvent::KeyboardActivate {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
            ...
            ButtonState::Idle => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == ButtonEvent::PointerEnter {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                        self.has_transition_actions = false;
            ...
            ButtonState::Pressed => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == ButtonEvent::PointerUp {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                        self.has_transition_actions = true;
