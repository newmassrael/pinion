...
// SCE-MAP: scroll_bar.scxml:37 :: _machine
...
impl ScrollBarEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [ScrollBarEvent] = &[
        ScrollBarEvent::Disable,
        ScrollBarEvent::Enable,
        ScrollBarEvent::PointerCancel,
        ScrollBarEvent::PointerDown,
        ScrollBarEvent::PointerEnter,
        ScrollBarEvent::PointerLeave,
        ScrollBarEvent::PointerUp,
    ];
}
...
pub struct ScrollBarPolicy {
    ...
    last_transition_source_state: ScrollBarState,
...
impl ScrollBarPolicy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: ScrollBarState::Idle,
...
impl StatePolicy for ScrollBarPolicy {
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            ScrollBarEvent::Disable => "disable",
            ScrollBarEvent::Enable => "enable",
            ScrollBarEvent::PointerCancel => "pointer_cancel",
            ScrollBarEvent::PointerDown => "pointer_down",
            ScrollBarEvent::PointerEnter => "pointer_enter",
            ScrollBarEvent::PointerLeave => "pointer_leave",
            ScrollBarEvent::PointerUp => "pointer_up",
            ScrollBarEvent::ScrollbarActivate => "scrollbar.activate",
            ScrollBarEvent::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            ...
            "pointer_cancel" => Some(ScrollBarEvent::PointerCancel),
            "pointer_down" => Some(ScrollBarEvent::PointerDown),
            "pointer_enter" => Some(ScrollBarEvent::PointerEnter),
            "pointer_leave" => Some(ScrollBarEvent::PointerLeave),
            "pointer_up" => Some(ScrollBarEvent::PointerUp),
            "scrollbar.activate" => Some(ScrollBarEvent::ScrollbarActivate),
            _ => None,
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "disabled" => Some(ScrollBarState::Disabled),
            "dragging" => Some(ScrollBarState::Dragging),
            "hover" => Some(ScrollBarState::Hover),
            "idle" => Some(ScrollBarState::Idle),
            _ => None,
        }
    }
    ...
    #[doc = "SCE-MAP: scroll_bar.scxml:37 :: _machine"]
// SCE-MAP: scroll_bar.scxml:37 :: _machine
        ...
        match self.last_transition_source_state {
            ScrollBarState::Dragging => {
                match self.last_transition_index {
                    0 => {
                        // SCE-MAP: scroll_bar.scxml:61 :: dragging :: _transition_0
                        // W3C SCXML 3.13: Transition 0 actions

// W3C SCXML 3.8.1: <raise event="scrollbar.activate">
engine.raise(sce_rust_runtime::EventWithMetadata::new(ScrollBarEvent::ScrollbarActivate));
                    }
                    _ => {}
                }
            }
...
impl ScrollBarPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: ScrollBarState,
        event: ScrollBarEvent,
        current_state: &mut ScrollBarState,
        ...
        match check_state {
            ScrollBarState::Disabled => {
                ...
                if event == ScrollBarEvent::Enable {
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = ScrollBarState::Idle;
            ...
            ScrollBarState::Dragging => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == ScrollBarEvent::PointerUp {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = ScrollBarState::Hover;
                            *transition_taken = true;
                        return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == ScrollBarEvent::PointerLeave {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == ScrollBarEvent::PointerCancel {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == ScrollBarEvent::Disable {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = ScrollBarState::Disabled;
                            *transition_taken = true;
                        return true;
                }
                false
            ...
            ScrollBarState::Hover => {
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == ScrollBarEvent::PointerDown {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 2;
                        self.has_transition_actions = false;
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = ScrollBarState::Dragging;
                            *transition_taken = true;
                        return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
            ...
            ScrollBarState::Idle => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == ScrollBarEvent::PointerEnter {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                        self.has_transition_actions = false;
