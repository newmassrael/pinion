...
// SCE-MAP: text_field.scxml:56 :: _machine
...
impl TextFieldEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [TextFieldEvent] = &[
        TextFieldEvent::BeginEdit,
        TextFieldEvent::Blur,
        TextFieldEvent::CancelEdit,
...
pub struct TextFieldPolicy {
    ...
    last_transition_source_state: TextFieldState,
...
impl TextFieldPolicy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: TextFieldState::Idle,
...
impl StatePolicy for TextFieldPolicy {
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            TextFieldState::Disabled => 3,
            TextFieldState::Editing => 2,
            TextFieldState::Focused => 1,
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            TextFieldEvent::BeginEdit => "begin_edit",
            TextFieldEvent::Blur => "blur",
            TextFieldEvent::CancelEdit => "cancel_edit",
            TextFieldEvent::CommitEdit => "commit_edit",
            TextFieldEvent::Disable => "disable",
            TextFieldEvent::Enable => "enable",
            TextFieldEvent::Focus => "focus",
            TextFieldEvent::TextfieldCommit => "textfield.commit",
            TextFieldEvent::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "begin_edit" => Some(TextFieldEvent::BeginEdit),
            "blur" => Some(TextFieldEvent::Blur),
            "cancel_edit" => Some(TextFieldEvent::CancelEdit),
            "commit_edit" => Some(TextFieldEvent::CommitEdit),
            "disable" => Some(TextFieldEvent::Disable),
            "enable" => Some(TextFieldEvent::Enable),
            "focus" => Some(TextFieldEvent::Focus),
            "textfield.commit" => Some(TextFieldEvent::TextfieldCommit),
            _ => None,
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "disabled" => Some(TextFieldState::Disabled),
            "editing" => Some(TextFieldState::Editing),
            "focused" => Some(TextFieldState::Focused),
            "idle" => Some(TextFieldState::Idle),
            _ => None,
        }
    }
    ...
    #[doc = "SCE-MAP: text_field.scxml:56 :: _machine"]
// SCE-MAP: text_field.scxml:56 :: _machine
        ...
        match self.last_transition_source_state {
            TextFieldState::Editing => {
                match self.last_transition_index {
                    0 => {
                        // SCE-MAP: text_field.scxml:86 :: editing :: _transition_0
                        // W3C SCXML 3.13: Transition 0 actions

// W3C SCXML 3.8.1: <raise event="textfield.commit">
engine.raise(sce_rust_runtime::EventWithMetadata::new(TextFieldEvent::TextfieldCommit));
                    }
                    2 => {
                        // SCE-MAP: text_field.scxml:90 :: editing :: _transition_2
...
impl TextFieldPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: TextFieldState,
        event: TextFieldEvent,
        current_state: &mut TextFieldState,
        ...
        match check_state {
            TextFieldState::Disabled => {
                ...
                if event == TextFieldEvent::Enable {
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = TextFieldState::Idle;
            ...
            TextFieldState::Editing => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == TextFieldEvent::CommitEdit {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = TextFieldState::Focused;
                            *transition_taken = true;
                        return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == TextFieldEvent::CancelEdit {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == TextFieldEvent::Disable {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = TextFieldState::Disabled;
                            *transition_taken = true;
                        return true;
                }
                false
            ...
            TextFieldState::Focused => {
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == TextFieldEvent::BeginEdit {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 1;
                        self.has_transition_actions = false;
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = TextFieldState::Editing;
                            *transition_taken = true;
                        return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
