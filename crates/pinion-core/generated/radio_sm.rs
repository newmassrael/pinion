...
// SCE-MAP: radio.scxml:18 :: _machine
...
impl RadioEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [RadioEvent] = &[
        RadioEvent::Disable,
        RadioEvent::Enable,
        RadioEvent::KeyboardActivate,
        RadioEvent::PointerCancel,
...
pub struct RadioPolicy {
    ...
    last_transition_source_state: RadioState,
...
impl RadioPolicy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: RadioState::Idle,
...
impl StatePolicy for RadioPolicy {
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            RadioState::Disabled => 3,
            RadioState::Hover => 1,
            RadioState::Idle => 0,
            RadioState::Pressed => 2,
        }
    }
    ...
    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            ...
            RadioEvent::KeyboardActivate => "keyboard_activate",
            RadioEvent::PointerCancel => "pointer_cancel",
            RadioEvent::PointerDown => "pointer_down",
            RadioEvent::PointerEnter => "pointer_enter",
            RadioEvent::PointerLeave => "pointer_leave",
            RadioEvent::PointerUp => "pointer_up",
            RadioEvent::RadioActivate => "radio.activate",
            RadioEvent::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            ...
            "keyboard_activate" => Some(RadioEvent::KeyboardActivate),
            "pointer_cancel" => Some(RadioEvent::PointerCancel),
            "pointer_down" => Some(RadioEvent::PointerDown),
            "pointer_enter" => Some(RadioEvent::PointerEnter),
            "pointer_leave" => Some(RadioEvent::PointerLeave),
            "pointer_up" => Some(RadioEvent::PointerUp),
            "radio.activate" => Some(RadioEvent::RadioActivate),
            _ => None,
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            ...
            "hover" => Some(RadioState::Hover),
            "idle" => Some(RadioState::Idle),
            "pressed" => Some(RadioState::Pressed),
            _ => None,
        }
    }
    ...
    #[doc = "SCE-MAP: radio.scxml:18 :: _machine"]
// SCE-MAP: radio.scxml:18 :: _machine
        ...
        match self.last_transition_source_state {
            RadioState::Hover => {
                match self.last_transition_index {
                    3 => {
                        // SCE-MAP: radio.scxml:70 :: hover :: _transition_3
                        // W3C SCXML 3.13: Transition 3 actions

// W3C SCXML 3.8.1: <raise event="radio.activate">
engine.raise(sce_rust_runtime::EventWithMetadata::new(RadioEvent::RadioActivate));
                    }
                    _ => {}
                }
            }
            RadioState::Idle => {
                match self.last_transition_index {
                    1 => {
                        // SCE-MAP: radio.scxml:60 :: idle :: _transition_1
...
engine.raise(sce_rust_runtime::EventWithMetadata::new(RadioEvent::RadioActivate));
            ...
            RadioState::Pressed => {
                match self.last_transition_index {
                    0 => {
                        // SCE-MAP: radio.scxml:77 :: pressed :: _transition_0
...
impl RadioPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: RadioState,
        event: RadioEvent,
        current_state: &mut RadioState,
        ...
        match check_state {
            ...
            RadioState::Hover => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == RadioEvent::PointerLeave {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                        self.has_transition_actions = false;
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == RadioEvent::PointerCancel {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == RadioEvent::PointerDown {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = RadioState::Pressed;
                            *transition_taken = true;
                        return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == RadioEvent::KeyboardActivate {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                ...
                if event == RadioEvent::Disable {
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = RadioState::Disabled;
                            *transition_taken = true;
                        return true;
                }
                false
            ...
            RadioState::Idle => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == RadioEvent::PointerEnter {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                        self.has_transition_actions = false;
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = RadioState::Hover;
                            *transition_taken = true;
                        return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
