...
// SCE-MAP: color_area.scxml:38 :: _machine
...
impl ColorAreaEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [ColorAreaEvent] = &[
        ColorAreaEvent::Disable,
        ColorAreaEvent::Enable,
        ColorAreaEvent::PointerCancel,
        ColorAreaEvent::PointerDown,
        ColorAreaEvent::PointerEnter,
        ColorAreaEvent::PointerLeave,
        ColorAreaEvent::PointerUp,
    ];
}
...
impl ColorAreaPolicy {
    pub fn new() -> Self {
        Self {
            last_transition_is_internal: false,
            last_transition_is_targetless: false,
            last_transition_source_state: ColorAreaState::Idle,
...
impl Default for ColorAreaPolicy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for ColorAreaPolicy {
    type State = ColorAreaState;
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            ColorAreaState::Disabled => 3,
            ColorAreaState::Dragging => 2,
            ColorAreaState::Hover => 1,
            ColorAreaState::Idle => 0,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            ColorAreaEvent::ColorAreaActivate => "color_area.activate",
            ColorAreaEvent::Disable => "disable",
            ColorAreaEvent::Enable => "enable",
            ColorAreaEvent::PointerCancel => "pointer_cancel",
            ColorAreaEvent::PointerDown => "pointer_down",
            ColorAreaEvent::PointerEnter => "pointer_enter",
            ColorAreaEvent::PointerLeave => "pointer_leave",
            ColorAreaEvent::PointerUp => "pointer_up",
            ColorAreaEvent::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "color_area.activate" => Some(ColorAreaEvent::ColorAreaActivate),
            "disable" => Some(ColorAreaEvent::Disable),
            "enable" => Some(ColorAreaEvent::Enable),
            "pointer_cancel" => Some(ColorAreaEvent::PointerCancel),
            "pointer_down" => Some(ColorAreaEvent::PointerDown),
            "pointer_enter" => Some(ColorAreaEvent::PointerEnter),
            "pointer_leave" => Some(ColorAreaEvent::PointerLeave),
            "pointer_up" => Some(ColorAreaEvent::PointerUp),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            ColorAreaState::Disabled => "disabled",
            ColorAreaState::Dragging => "dragging",
            ColorAreaState::Hover => "hover",
            ColorAreaState::Idle => "idle",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "disabled" => Some(ColorAreaState::Disabled),
            "dragging" => Some(ColorAreaState::Dragging),
            "hover" => Some(ColorAreaState::Hover),
            "idle" => Some(ColorAreaState::Idle),
            _ => None,
        }
    }
    ...
    #[doc = "SCE-MAP: color_area.scxml:38 :: _machine"]
// SCE-MAP: color_area.scxml:38 :: _machine
...
// SCE-MAP: color_area.scxml:38 :: _machine
    fn execute_transition_actions(&mut self, engine: &mut sce_rust_runtime::Engine<Self>) {
        ...
        match self.last_transition_source_state {
            ColorAreaState::Dragging => {
                match self.last_transition_index {
                    0 => {
                        // SCE-MAP: color_area.scxml:56 :: dragging :: _transition_0
                        // W3C SCXML 3.13: Transition 0 actions

// W3C SCXML 3.8.1: <raise event="color_area.activate">
engine.raise(sce_rust_runtime::EventWithMetadata::new(ColorAreaEvent::ColorAreaActivate));
                    }
                    _ => {}
                }
            }
...
impl ColorAreaPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: ColorAreaState,
        event: ColorAreaEvent,
        current_state: &mut ColorAreaState,
        transition_taken: &mut bool,
        engine: &mut sce_rust_runtime::Engine<Self>,
    ) -> bool {
        match check_state {
            ColorAreaState::Disabled => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == ColorAreaEvent::Enable {
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = ColorAreaState::Idle;
            ...
            ColorAreaState::Dragging => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == ColorAreaEvent::PointerUp {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = ColorAreaState::Hover;
                            *transition_taken = true;
                        return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == ColorAreaEvent::PointerLeave {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == ColorAreaEvent::PointerCancel {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == ColorAreaEvent::Disable {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = ColorAreaState::Disabled;
                            *transition_taken = true;
                        return true;
                }
                false
            }
            ColorAreaState::Hover => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == ColorAreaEvent::PointerLeave {
                        // W3C SCXML 3.4: Track transition metadata
                ...
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == ColorAreaEvent::PointerDown {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 2;
                        self.has_transition_actions = false;
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = ColorAreaState::Dragging;
                            *transition_taken = true;
                        return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
            ...
            ColorAreaState::Idle => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == ColorAreaEvent::PointerEnter {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                        self.has_transition_actions = false;
