...
// SCE-MAP: dock_panel.scxml:50 :: _machine
...
impl DockPanelEvent {
    ...
    /// on the name.
    pub const EXTERNALLY_DRIVABLE_EVENTS: &'static [DockPanelEvent] = &[
        DockPanelEvent::DockBack,
        DockPanelEvent::Dropped,
        DockPanelEvent::Escaped,
        DockPanelEvent::LeaveZone,
        DockPanelEvent::OverZone,
    ];
}
...
impl DockPanelPolicy {
    pub fn new() -> Self {
        Self {
            ...
            last_transition_source_state: DockPanelState::Docked,
...
impl Default for DockPanelPolicy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl StatePolicy for DockPanelPolicy {
    type State = DockPanelState;
    type Event = DockPanelEvent;
    ...
    fn get_document_order(state: Self::State) -> u32 {
        match state {
            DockPanelState::Docked => 0,
            DockPanelState::Floating => 1,
            DockPanelState::RedockArmed => 2,
        }
    }

    fn get_event_name(event: Self::Event) -> &'static str {
        match event {
            DockPanelEvent::DockBack => "dock_back",
            DockPanelEvent::DockPanelFloat => "dock_panel.float",
            DockPanelEvent::DockPanelRedock => "dock_panel.redock",
            DockPanelEvent::DockPanelRestore => "dock_panel.restore",
            DockPanelEvent::Dropped => "dropped",
            DockPanelEvent::Escaped => "escaped",
            DockPanelEvent::LeaveZone => "leave_zone",
            DockPanelEvent::OverZone => "over_zone",
            DockPanelEvent::Null => "",
        }
    }
    ...
    fn get_event_from_name(name: &str) -> Option<Self::Event> {
        match name {
            "dock_back" => Some(DockPanelEvent::DockBack),
            "dock_panel.float" => Some(DockPanelEvent::DockPanelFloat),
            "dock_panel.redock" => Some(DockPanelEvent::DockPanelRedock),
            "dock_panel.restore" => Some(DockPanelEvent::DockPanelRestore),
            "dropped" => Some(DockPanelEvent::Dropped),
            "escaped" => Some(DockPanelEvent::Escaped),
            "leave_zone" => Some(DockPanelEvent::LeaveZone),
            "over_zone" => Some(DockPanelEvent::OverZone),
            _ => None,
        }
    }
    ...
    fn get_state_name(state: Self::State) -> &'static str {
        match state {
            DockPanelState::Docked => "docked",
            DockPanelState::Floating => "floating",
            DockPanelState::RedockArmed => "redock_armed",
        }
    }
    ...
    fn get_state_from_name(name: &str) -> Option<Self::State> {
        match name {
            "docked" => Some(DockPanelState::Docked),
            "floating" => Some(DockPanelState::Floating),
            "redock_armed" => Some(DockPanelState::RedockArmed),
            _ => None,
        }
    }
    ...
    #[doc = "SCE-MAP: dock_panel.scxml:50 :: _machine"]
// SCE-MAP: dock_panel.scxml:50 :: _machine
        ...
        match self.last_transition_source_state {
            DockPanelState::Docked => {
                match self.last_transition_index {
                    0 => {
                        // SCE-MAP: dock_panel.scxml:57 :: docked :: _transition_0
                        // W3C SCXML 3.13: Transition 0 actions

// W3C SCXML 3.8.1: <raise event="dock_panel.float">
engine.raise(sce_rust_runtime::EventWithMetadata::new(DockPanelEvent::DockPanelFloat));
                    }
                    _ => {}
                }
            }
            DockPanelState::Floating => {
                match self.last_transition_index {
                    1 => {
                        // SCE-MAP: dock_panel.scxml:68 :: floating :: _transition_1
                        // W3C SCXML 3.13: Transition 1 actions

// W3C SCXML 3.8.1: <raise event="dock_panel.redock">
engine.raise(sce_rust_runtime::EventWithMetadata::new(DockPanelEvent::DockPanelRedock));
                    }
                    2 => {
                        // SCE-MAP: dock_panel.scxml:73 :: floating :: _transition_2
                        // W3C SCXML 3.13: Transition 2 actions

// W3C SCXML 3.8.1: <raise event="dock_panel.restore">
engine.raise(sce_rust_runtime::EventWithMetadata::new(DockPanelEvent::DockPanelRestore));
                    }
                    _ => {}
                }
            }
            DockPanelState::RedockArmed => {
                match self.last_transition_index {
                    1 => {
                        // SCE-MAP: dock_panel.scxml:83 :: redock_armed :: _transition_1
                        // W3C SCXML 3.13: Transition 1 actions
...
engine.raise(sce_rust_runtime::EventWithMetadata::new(DockPanelEvent::DockPanelRedock));
                    ...
                    2 => {
                        // SCE-MAP: dock_panel.scxml:87 :: redock_armed :: _transition_2
                        // W3C SCXML 3.13: Transition 2 actions
...
impl DockPanelPolicy {
    ...
    fn try_transition_in_state(
        &mut self,
        check_state: DockPanelState,
        event: DockPanelEvent,
        current_state: &mut DockPanelState,
        ...
        match check_state {
            DockPanelState::Docked => {
                ...
                if event == DockPanelEvent::Escaped {
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = DockPanelState::Floating;
            ...
            DockPanelState::Floating => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == DockPanelEvent::OverZone {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                        self.has_transition_actions = false;
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = DockPanelState::RedockArmed;
                            *transition_taken = true;
                        return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == DockPanelEvent::Dropped {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        ...
                        self.last_transition_is_targetless = false;
                            ...
                            *current_state = DockPanelState::Docked;
                            *transition_taken = true;
                        return true;
                }
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == DockPanelEvent::DockBack {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
            ...
            DockPanelState::RedockArmed => {
                // W3C SCXML 3.12: Event-triggered transitions (document order)
                // W3C SCXML 5.9.3: Direct enum comparison
                if event == DockPanelEvent::LeaveZone {
                        // W3C SCXML 3.4: Track transition metadata
                        self.last_transition_source_state = check_state;
                        self.last_transition_index = 0;
                        self.has_transition_actions = false;
