...
pub const SCHEMA_FIELDS: &[SchemaField] = &[
    ...
    SchemaField::new("speaker", "string"),
    SchemaField::new("line", "string"),
    SchemaField::new("revealed", "string"),
    ...
    SchemaField::new("outcome", "string"),
    SchemaField::new("outcome_label", "string"),
    SchemaField::new("timed_out", "bool"),
    SchemaField::new("script", "json"),
    SchemaField::new("background", "string"),
