...
pub const RPC_METHODS: &[(&str, MethodOcc)] = &[
    ...
    ("scene/memory", MethodOcc::Read),
    ("scene/mnemonics", MethodOcc::Read),
    ("scene/modifiers", MethodOcc::Mutate),
    ("scene/pacing_state", MethodOcc::Read),
    ("scene/pan_gesture", MethodOcc::Read),
    ...
    ("scene/pointer_tangential_pressure", MethodOcc::Mutate),
    ("scene/pointer_tilt", MethodOcc::Mutate),
    ("scene/pointer_twist", MethodOcc::Mutate),
    ("scene/pointer_type", MethodOcc::Mutate),
    ...
    ("scene/subscribe", MethodOcc::Read),
    ("scene/subscriptions", MethodOcc::Read),
    ...
    ("scene/unsubscribe", MethodOcc::Read),
