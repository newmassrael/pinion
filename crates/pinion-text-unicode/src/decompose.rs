...
use crate::tables::{
    ...
    CANONICAL_DECOMPOSITION_SUPPLEMENTARY, COMPATIBILITY_DECOMPOSITION_BMP_DATA,
    COMPATIBILITY_DECOMPOSITION_BMP_INDEX, COMPATIBILITY_DECOMPOSITION_DATA,
    COMPATIBILITY_DECOMPOSITION_FIRST_CP, COMPATIBILITY_DECOMPOSITION_SUPPLEMENTARY,
};
