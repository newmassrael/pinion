...
- R700 = Table (Model/View, multi-round — virtualization substrate-first) / Drawer (anchored edge slide + overlay-dismiss substrate-first) / Accordion single-open variant / DatePicker / ColorPicker. 진입 시 class(command/selection/descriptive/container) + substrate 전제 먼저 감사
