//! R1947 §5.50 pinion-forge codegen entrypoint for hello-topology-view.
//!
//! Identical shape to every other example's `build.rs`: compiles
//! `app.pinion.xml` to `$OUT_DIR/app.rs`, which `lib.rs` pulls in via
