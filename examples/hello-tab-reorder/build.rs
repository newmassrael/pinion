//! R743 §5.16 §5.51 pinion-forge codegen entrypoint for
//! hello-tab-reorder. Mirrors every other `examples/<binding>/build.rs` —
//! compile `app.pinion.xml` to `$OUT_DIR/app.rs` for the binary to
//! include.
