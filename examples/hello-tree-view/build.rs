//! R673 §5.16 §5.50 pinion-forge codegen entrypoint for
//! hello-tree-view. Mirrors hello-button / hello-tabs / every other
//! `examples/<binding>/build.rs` — compile `app.pinion.xml` to
//! `$OUT_DIR/app.rs` for the binary to include.
