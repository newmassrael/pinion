//! R1462 §5.16 §5.39 pinion-forge codegen entrypoint for hello-modal-refocus.
//! Mirrors every other `examples/<binding>/build.rs` — compile
//! `app.pinion.xml` to `$OUT_DIR/app.rs` for the binary to include.
