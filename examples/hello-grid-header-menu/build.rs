//! R986 §5.27 §5.38 §5.53 pinion-forge codegen entrypoint for
//! hello-grid-header-menu. Identical shape to the other hello-* binary
//! build scripts — the renderer manifest in `app.pinion.xml` is the only
//! divergence (struct name = `HelloGridHeaderMenuRenderer`).
