//! R655 §5.16 pinion-forge codegen entrypoint for `todomvc`.
//!
//! Identical shape to hello-toggle / hello-textfield `build.rs`
//! (R51.29 / R56.1.b.1): compiles `app.pinion.xml` to
//! `$OUT_DIR/app.rs`, which `main.rs` pulls in via
