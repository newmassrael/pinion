//! R1753 §5.45 §5.35 pinion-forge codegen entrypoint for
//! `hello-content-drag`. Identical shape to the other hello-* binary build
//! scripts — the renderer manifest in `app.pinion.xml` is the only divergence
//! (struct name = `HelloContentDragRenderer`).
