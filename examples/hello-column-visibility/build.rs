//! R990 §5.27 §5.38 §5.40 pinion-forge codegen entrypoint for
//! hello-column-visibility. Identical shape to the other hello-* binary
//! build scripts — the renderer manifest in `app.pinion.xml` is the only
//! divergence (struct name = `HelloColumnVisibilityRenderer`).
