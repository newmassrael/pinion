//! R989 §5.16 §5.38 §5.40 pinion-forge codegen entrypoint for
//! hello-selection-toolbar. Identical shape to the other hello-* binary
//! build scripts — the renderer manifest in `app.pinion.xml` is the only
//! divergence (struct name = `HelloSelectionToolbarRenderer`).
