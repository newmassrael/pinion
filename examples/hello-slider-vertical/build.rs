//! R51.46 §5.38 pinion-forge codegen entrypoint for
//! hello-slider-vertical. Identical shape to the other hello-*
//! build scripts; only the renderer struct name diverges.
