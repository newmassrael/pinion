//! R57.0 §5.50 pinion-forge codegen entrypoint for hello-theme.
//!
//! Compiles `app.pinion.xml` to `$OUT_DIR/app.rs`, which `main.rs`
//! pulls in via `include!(concat!(env!("OUT_DIR"), "/app.rs"))`.
//! Identical shape to hello-toggle / hello-button.
