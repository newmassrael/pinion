//! R764 §5.22 pinion-forge codegen entrypoint for hello-textarea.
//!
//! Identical shape to hello-textfield's `build.rs`: compiles
//! `app.pinion.xml` to `$OUT_DIR/app.rs`, pulled into `main.rs` via
