//! R701 §5.38 pinion-forge codegen entrypoint for
//! hello-accordion-single. Identical shape to the other hello-* binary
//! build scripts — the renderer manifest in `app.pinion.xml` is the
//! only divergence (struct name = `HelloAccordionSingleRenderer`).
