//! R838 §5.16 pinion-forge codegen entrypoint for `hello-node-editor`.
//! Mirrors `examples/hello-data-grid/build.rs` — compiles `app.pinion.xml`
//! to `$OUT_DIR/app.rs` which `main.rs` pulls in via `include!`.
