//! R770 §5.15 pinion-forge codegen entrypoint for hello-filedrop.
//!
//! Compiles `app.pinion.xml` to `$OUT_DIR/app.rs`, pulled into `main.rs`
//! via `include!(concat!(env!("OUT_DIR"), "/app.rs"))`.
