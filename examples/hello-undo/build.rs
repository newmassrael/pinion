//! R748 §5.52 pinion-forge codegen entrypoint for hello-undo. Identical
//! shape to the other hello-* binary build scripts — the renderer manifest
//! in `app.pinion.xml` is the only divergence (struct name =
//! `HelloUndoRenderer`).
