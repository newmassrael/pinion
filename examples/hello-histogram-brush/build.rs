//! R1395 pinion-forge codegen entrypoint for hello-histogram-brush.
//!
//! Identical shape to hello-linked-brush's `build.rs`: compiles `app.pinion.xml`
//! to `$OUT_DIR/app.rs`, which `main.rs` pulls in via
