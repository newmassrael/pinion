...
impl ExternalIntrospect for MapViewport {
    ...
    fn query(&self, path: &str) -> Result<IntrospectValue, ReadRefusal> {
        match path {
            "offset_x" => Ok(IntrospectValue::Float(self.offset.0)),
            "offset_y" => Ok(IntrospectValue::Float(self.offset.1)),
            "offset_at_begin_x" => Ok(IntrospectValue::Float(self.offset_at_begin.0)),
            "offset_at_begin_y" => Ok(IntrospectValue::Float(self.offset_at_begin.1)),
            "delta_x" => Ok(IntrospectValue::Float(self.delta.0.into())),
            "delta_y" => Ok(IntrospectValue::Float(self.delta.1.into())),
