//! R774 §5.27 pinion-forge codegen entrypoint for
//! hello-flex-virtual-list. Identical shape to the other hello-* binary
//! build scripts — the renderer manifest in `app.pinion.xml` is the only
//! divergence (struct name = `HelloFlexVirtualListRenderer`).
