//! R51.104 §5.38 pinion-forge codegen entrypoint for
//! hello-listbox-multi. Identical shape to the other hello-* binary
//! build scripts — the renderer manifest in `app.pinion.xml` is the
//! only divergence (struct name = `HelloListboxMultiRenderer`).
