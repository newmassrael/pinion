//! R790 §5.15 §5.16 §5.38 §5.39 pinion-forge codegen entrypoint for
//! hello-file-save-dialog. Mirrors every other `examples/<binding>/build.rs`
//! — compile `app.pinion.xml` to `$OUT_DIR/app.rs` for the binary to include.
