//! R836 §5.16 pinion-forge codegen entrypoint for `hello-property-grid`.
//! Mirrors `examples/todomvc/build.rs` — compiles `app.pinion.xml` to
//! `$OUT_DIR/app.rs` which `main.rs` pulls in via `include!`.
