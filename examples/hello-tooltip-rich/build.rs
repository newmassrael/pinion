//! R729 §5.38 pinion-forge codegen entrypoint for hello-tooltip-rich.
//! Identical shape to the other hello-* binary build scripts — only the
//! renderer struct name in `app.pinion.xml` diverges
//! (`HelloTooltipRichRenderer`).
