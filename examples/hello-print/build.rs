//! R832 pinion-forge codegen entrypoint for hello-menu-app. Mirrors
//! every other `examples/<binding>/build.rs` — compile `app.pinion.xml`
//! to `$OUT_DIR/app.rs` for the binary to include.
